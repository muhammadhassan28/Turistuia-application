...
import 'package:turistica_app/password2.dart';

class PasswordSecret extends StatefulWidget{
  @override
  State<PasswordSecret> createState() => _PasswordSecretState();
}

class _PasswordSecretState extends State<PasswordSecret> {
  @override
           ...
           children: [
             ...
             Container(
               ...
               child: ElevatedButton(onPressed: (){
                 Navigator.push(context, MaterialPageRoute(builder: (context)=> PasswordSecret2()));
               },
